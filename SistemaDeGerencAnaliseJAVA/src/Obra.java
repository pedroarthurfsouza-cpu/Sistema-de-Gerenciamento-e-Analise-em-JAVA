...
public Obra(String titulo, TipoObra tipo, Autor autor, ArrayList<Genero> generos, int totalCapitulos, String sinopse,
        String idExterno, ArrayList<Avaliacao> avaliacoes) {
    this.titulo = titulo;
    this.tipo = tipo;
    this.autor = autor;
